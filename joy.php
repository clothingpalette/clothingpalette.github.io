...
$yourEmail = "clothingpalette12@gmail.com"; // the email address you wish to receive these mails through
$yourWebsite = "clothingpalette"; // the name of your website
$thanksPage = ''; // URL to 'thanks for sending mail' page; leave empty to keep message on the same page 
$maxPoints = 4; // max points a person can hit before it refuses to submit - recommend 4
$requiredFields = "name,phone number,email,message"; // names of the fields you'd like to be required as a minimum, separate each field with a comma
